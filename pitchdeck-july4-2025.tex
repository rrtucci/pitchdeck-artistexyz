...
\BSframe{Present: Video by Bob Modesta}
In \href{https://youtu.be/GLDqs099mXE}{this short 9 min video}, a very convincing university lecturer named Bob Moesta relates his highly successful personal experiences applying Causal Inference principles to selling real estate. It made me think of Zillow. Zillow had a fairly large AI team doing non-causal AI, and the results were catastrophic. (NOTA BENE: Bob Moesta does not work for our company.)
\end{frame}
\BSframe{Present: Clayton Christensen on Causality}
Clayton Christensen was a renowned American academic and business consultant who invented and developed the theory of disruptive innovation. He influenced many famous business leaders and entrepreneurs.

$$
\includegraphics[width=.8\textwidth]{clayton-christensen-causality.jpeg}
$$
...
\BSframe{Other startups doing what we do}


\end{frame}

\BSframe{Mappa Mundi (MM)}

We have written open source software called Mappa Mundi (MM) that seamlessly combines 2 giant topics in Artificial Intelligence (AI):
\begin{itemize}
...
\begin{itemize}
\item MM is free open source software that extracts causal networks (DAGs) from text.
...
\item MM is immune to copyright infringement lawsuits because 1 and 2 do not use copyrighted data to train.
...
\href{https://github.com/rrtucci/gene_causal_mapper}{Gene\_Causal\_Mapper} is a python program for discovering a causal DAG for genes via the MM algorithm.
